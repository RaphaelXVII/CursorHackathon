...
A Next.js 16.2.7 (App Router) frontend for PromptTuber. Users type a character description, hit Generate, and watch their Live2D VTuber avatar come to life. Face tracking is enabled via a toggle that connects to a backend WebSocket stream.
